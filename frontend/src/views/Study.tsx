...
import { getAllCareers, getRecommendCourses, getSkills } from "services/studyService";
...
function StudyPath() {
  ...
  //     setLoading("career");
  //     setJobs([]);
  //     const careersId: number[] = selectedCourses.map((c) => c.id);
  //     const { data } = await getRecommendCareer(careersId);
